...
const Calender = () => {
  ...
  const [editOtherEvents , setEditOtherEvents] = useState(false);
  ...
  const submitOtherEvent = () => {
    setEditOtherEvents(!editOtherEvents)
                ...
                <ModalBody>
                  ...
                  >
                    ...
                    <div className="hstack gap-2 justify-content-end">
                      ...
                      {console.log("isEdit",isEdit, editOtherEvents)}
                      {editOtherEvents && (
                        <button
                          type="submit"
