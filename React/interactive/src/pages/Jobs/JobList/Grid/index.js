...
const JobGrid = () => {
  ...
  const searchData = jobGrid.filter((item) =>
    item.companyName.toLowerCase().includes(state.companyName.toLowerCase())
  )
                      ...
                      <Col xxl={2} sm={4}>
                        <div className="input-light">
                          <select
                            ...
                            id="idType"
                            name="requirement"
                            onChange={(e) => OnchangeHandler(e, "requirement")}
                          >
                  ...
                  <Col lg={3} md={6} key={key}>
                    <Card>
                      <CardBody>
                        <button
                          type="button"
                          className={favouritebtn ? "btn btn-icon btn-soft-primary float-end" : "btn btn-icon btn-soft-primary float-end active"}
                        ...
                        <div className="hstack gap-2">{item.requirement} </div>
