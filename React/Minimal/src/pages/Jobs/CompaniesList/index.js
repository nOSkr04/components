              ...
              <Card id="company-overview">
                ...
                <div className="card-body">
                  ...
                  <p className="text-muted mb-4 overview-companydesc">
                    {data.company_info || "The IT department of NavLink company ensures that the network of computers within the organisation are well-connected and functioning properly. All the other departments within the company rely on them to ensure that their respective functions can go on seamlessly."}
                  </p>
                  ...
                  <div className="hstack gap-3">
                    ...
                    >
                      {
                        !isToggle ? <span className="icon-on">
