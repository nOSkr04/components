                                ...
                                <Card className="explore-box">
                                    <CardBody>
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <h6 className="fs-15 mb-0"><Link to="/apps-nft-item-details" className="link-dark">{item.category}</Link></h6>
                                        </div>
                                    </CardBody>
                                </Card>
                            </Col>
                        ...
                        {nftArtworkData.map((item, key) => (
                            <Col key={key}>
                                <Card className="explore-box card-animate">
                                    ...
                                    <CardBody>
                                        <p className="fw-medium mb-0 float-end"><i className="mdi mdi-heart text-danger align-middle"></i> {item.likes} </p>
                                        <h5 className="mb-1 fs-15"><Link to="/apps-nft-item-details">{item.title}</Link></h5>
