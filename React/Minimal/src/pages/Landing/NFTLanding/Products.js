                            ...
                            <Col key={key} lg={4} className={"product-item " + item.isClass}>
                                <div className="card explore-box card-animate">
                                    <div className="bookmark-icon position-absolute top-0 end-0 p-2">
                                        <button type="button" className="btn btn-icon" data-bs-toggle="button" aria-pressed="true"><i className="mdi mdi-cards-heart fs-16"></i></button>
                                    </div>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <h5 className="mb-1 fs-16"><Link to="/apps-nft-item-details" className="link-dark">{item.title}</Link></h5>
