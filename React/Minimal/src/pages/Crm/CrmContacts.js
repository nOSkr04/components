                ...
                <CardBody className="text-center">
                  ...
                  <ul className="list-inline mb-0">
                    ...
                    <li className="list-inline-item avatar-xs">
                      <Link
                        to="#"
                        className="avatar-title bg-soft-primary text-primary fs-15 rounded"
                      >
                    ...
                    <Table className="table table-borderless mb-0">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {(info.tags || ["Lead", "Partner"]).map((item, key) => (<span className="badge badge-soft-secondary me-1" key={key}>{item}</span>))}
                          </td>
                        </tr>
                        <tr>
                          <td className="fw-medium">
